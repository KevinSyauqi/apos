...
class _CartOrderState extends State<CartOrder>
  ...
  _onPayLaterButtonPressed(List<OrderItem> listOrderItem,
      int totalPrice) async {
    await _checkoutBloc.add(
        PayLater(listOrderItem: listOrderItem, totalPrice: totalPrice));
  }

  _onPayNowButtonPressed(List<Menu> listMenu,
      List<OrderItem> listSalesLineItem, int totalPrice) async {
    await _checkoutBloc.add(
        PayNow(listMenu: listMenu,
            listOrderItem: listSalesLineItem,
          ...
          body: BlocBuilder<CartBloc, CartState>(
              builder: (context, state) {
                ...
                if (state is CartLoaded) {
                  ...
                  print(
                      "Jumlah Sales Line Item :" + listOrder.length.toString());
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: <Widget>[
                                                ...
                                                children: <Widget>[
                                                  Text(item.name_menu,
                                                      style: TextStyle(
                                                          ...
                                                          'CircularStd-Bold')),
                                                  Text(
                                                      "Rp " + (item.subtotal_price/item.quantity).toInt().toString() +
                                                          " x " +
                                          ...
                                          Expanded(
                                              child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: <Widget>[
                                                      Text(
                                                          "Rp " + item.subtotal_price.toString(),
                                                          style: TextStyle(
                                                              color: Colors
                                                                  .black,
                                                              fontSize: 16.0,
                          ...
                          checkout(menus,listOrder, currentState.totalPrice),
                        ],
                      ),
                    ),
  ...
  Widget checkout(List<Menu> menus, List<OrderItem> listOrderItem, int totalPrice) {
    return Positioned(
      child: Container(
        child: Column(
                ...
                Container(
                  ...
                  child: ButtonTheme(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () async {
                        if (_checkoutBloc.state is CartLoaded) {
